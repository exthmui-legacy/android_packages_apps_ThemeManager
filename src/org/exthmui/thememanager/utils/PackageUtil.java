...
public class PackageUtil {
    ...
    public static void installPackage(Context context, InputStream inputStream, PackageInstallerStatusListener listener) {
        ...
        context.registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (successFlag) {
                    listener.onSuccessListener(packageName);
                } else {
                    listener.onFailureListener(packageName, statusCode);
                }
            }
    ...
    public static void uninstallPackage(Context context, String packageName, PackageInstallerStatusListener listener) {
    ...
    public interface PackageInstallerStatusListener {
        void onSuccessListener(String packageName);
        void onFailureListener(String packageName, int code);
    }
